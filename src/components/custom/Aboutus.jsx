      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-indigo-600 max-w-2xl mx-auto">
            Empowering you with unbiased, multi-source insights for a clearer view of the world.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-3xl p-12 mb-20 shadow-xl ring-1 ring-blue-200"
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-lg text-gray-800 leading-relaxed max-w-3xl mx-auto text-center"
          >
            ...
            believe that seeing multiple perspectives is essential for forming independent opinions and critical thinking.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg mb-16">
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-10 shadow-xl ring-1 ring-indigo-100">
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl p-8 shadow-md hover:shadow-xl transform hover:-translate-y-2 transition h-full"
    >
      <div className="flex flex-col items-center text-center">
        <motion.div
          whileHover={{ scale: 1.1 }}
          className="mb-6 p-4 bg-gradient-to-br from-indigo-600 to-blue-600 text-white rounded-full shadow-lg"
        >
          {icon}
        </motion.div>
...
const ValueCard = ({ title, description }) => {
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl p-8 shadow-md hover:shadow-lg transform hover:-translate-y-1 transition h-full border-l-4 border-indigo-500"
    >
      <h3 className="text-xl font-semibold text-indigo-900 mb-3 uppercase">{title}</h3>
      <p className="text-gray-700 leading-relaxed">{description}</p>
    </motion.div>
  );
};
